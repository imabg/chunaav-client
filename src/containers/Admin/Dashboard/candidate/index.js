...
import {fetchCandidateInfo, addCandidate, updateCandidate, deleteCandidate} from "../action"
              ...
              <div className="text-center">
                ...
                <div className="mt-4">
                  <Button
                    ...
                    disabled={disableBtn}
                    onClick={
                      btnType === "Add" ? saveNewCandidate : handleUpdateCandidate
                    }
                  >
                    {btnType === "Add" ? "Add new Candidate" : "Update Candidate"}
                  </Button>
                </div>
              </div>
            )}
